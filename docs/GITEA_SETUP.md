...
Cairn can store its extension inventory as a JSON file in a Gitea repository.
...
- **File path:** where Cairn should keep the inventory, such as
...
write and Cairn asks you to pull and compare instead of silently overwriting it.
